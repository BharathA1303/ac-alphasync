                    ...
                    <table className="w-full text-sm min-w-[1180px]">
                        ...
                        <tbody>
                            {holdings.map((h, i) => {
                                ...
                                return (
                                    <tr key={h.symbol || i} className="border-b border-edge/[0.025] hover:bg-primary-500/5 transition-colors">
                                        <td
                                            onClick={() => handleSelectSymbol(h.symbol)}
                                            className="py-2.5 px-3 font-semibold text-heading cursor-pointer hover:text-primary-600 transition-colors"
                                            title={`Click to load ${h.symbol} chart in Terminal`}
                                        >
