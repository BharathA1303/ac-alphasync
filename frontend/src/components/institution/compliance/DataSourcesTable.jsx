            ...
            <div>
                ...
                <div className="overflow-x-auto mt-2">
                    <table className="w-full text-left text-xs font-mono">
                        <thead>
                            <tr className="border-b border-edge/10 text-[10px] uppercase font-bold text-slate-500 dark:text-slate-400">
                            ...
                            {sources.map((s) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <td className="py-2 px-2 font-sans text-slate-700 dark:text-slate-300 text-[11px]">
                                            {s.scope}
                                        </td>
